...
let largeShirts = [];
 largeShirts.push(runners.filter(e => e.shirt_size == 'L'));
console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
let ticketPriceTotal = [];
const sum = runners.reduce((acc, curr) => {
...
// Problem 1
//Collect all runners emails and push them to allEmails array.
const allEmails = [];
runners.forEach(e => {
...
// Problem 2
//Filter and push to an array donations larger than 200.
const largeDonations = [];
 largeDonations.push(runners.filter(e => e.donation > 200));
console.log(largeDonations);

// Problem 3
// Push small shirt sizes to smallSizes array
const smallSizes = [];
runners.map(e => {
    if(e.shirt_size === 'S'){
      smallSizes.push(e);
